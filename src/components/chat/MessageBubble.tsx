  ...
  return (
    <div className={`flex group ${msg.role === "user" ? "justify-end" : "justify-start"}`}>
      ...
      >
        {/* Avatar for AI */}
        {msg.role === "assistant" && (
          <div className="relative w-8 h-8 shrink-0 rounded-full bg-zinc-900 border border-zinc-800 flex items-center justify-center overflow-hidden">
            <AvatarImage
            ...
            <div className="relative group/bubble">
              ...
              >
                ...
                <div className="relative">
                  ...
                  {activeMenuId === msg.id && (
                    <div
                      className={`absolute bottom-full mb-2 w-32 bg-zinc-900 border border-zinc-800 rounded-xl shadow-2xl z-50 py-1 ${
